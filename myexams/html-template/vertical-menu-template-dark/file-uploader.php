    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="active nav-item"><a href="ext-component-file-uploader.html"><i class="feather icon-upload-cloud"></i><span class="menu-title" data-i18n="File Uploader">File Uploader</span></a>
                </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <section id="dropzone-examples">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <p class="card-text">
                                        <form action="controller.php" method="POST" class="dropzone dropzone-area" id="dp-accept-files" enctype="multipart/form-data">
                                        <?php
                                $exam = $_GET['exam_id'];
                                $subject = $_GET['subject_id'];
                                $option_type=$_GET["option_id"];
                                ?>
                                <input type="hidden" name="question" id="question" >
                                <input type="hidden" name="option[]" id="option" >
                                <input type="hidden" name="answers" id="answer" >
                        <input type="hidden" value="<?php echo $exam; ?>" name="exam_id">
                                <input type="hidden" value="<?php echo $subject; ?>" name="subject_id">
                                <input type="hidden" value="<?php echo $option_type; ?>" name="option_id">
                                            <input type="file" class="dz-message" name="file">
                    ...
                    <?php
        if(isset($_GET["subject_name"]) && isset($_GET["exam_name"]) && isset($_GET["option_name"]) ) {
