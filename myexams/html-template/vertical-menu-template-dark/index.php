                                            ...
                                            <div class="card-body pt-1">
                                                <form action="validator.php" method="post">
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        <input type="text" class="form-control" name="email" id="user-name" placeholder="email" required>
                                                    ...
                                                    <?php                            
                                                            ...
                                                            <p name="message" class="message"><?php echo $_SESSION['msg1'];?></p>
                                                            <?php unset($_SESSION['msg1']); ?>
                                                            <?php } ?>
                                                          <?php  if(isset($_SESSION['msg2'])){   ?>
                                                            <p name="message" class="message"><?php echo $_SESSION['msg2'];?></p> 
                                                            <?php unset($_SESSION['msg2']); ?>
                                                            <?php } ?>
                                                            
                                                    <a href="registration.php" class="btn btn-outline-primary float-left btn-inline">Register</a>
                                                    <button type="submit" name="login_btn" class="btn btn-primary float-right btn-inline">Login</button>
                                                </form>
                                            </div>
                                        </div>
