                        ...
                        <div class="col-12">
                            <div class="card">                    
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <h2>PRESS START WHEN YOU ARE READY<br> THE EXAMS LASTS FOR 1MINUTE <br> GOODLUCK </h2>
                                       
                                            <a href="exam-page.php" ><button type="button"class="btn btn-primary" style="margin-top: 50px;">START</button>
                                        </ul>
                                    </div>
                                </div>
                            </div>
