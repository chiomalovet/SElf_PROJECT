                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Select Exam and Subject</h4>
                                </div>
                                <div class="card-content">
                                <?php $exams= exam();
                                       $subjects= subject();
                                       $option_types=option_type()?>
                <form action="create-questions.php" method="GET">
                                    <div class="card-body">
                                        <div class="row">
                                           ...
                                           <?php }?> 
                                            ...
                                            <div class="col-sm-6 col-12">
                                                ...
                                                <div class="form-group">
                                                    <select class="select2 form-control" name="option_id">
                                               <?php foreach($option_types as $option_type) {?>              
                                                   <option  value="<?php echo $option_type['option_id'];?>"><?php echo $option_type["option_name"];?></option>
                                               <?php }?> 
                                                    </select>
                                                </div>
                                            </div>
                                            <button class="btn btn-primary" type="submit" style="margin-top: 100px; margin-left:-450px">Submit</button>
                                            </form> 
                                        </div>
                                    </div>
