                                            ...
                                            <div class="card-body pt-0">
                                                <form action="controller.php" method="post">
                                                    <!-- <div class="form-label-group">
                                                        <input type="text" id="inputName" name="uname" class="form-control" placeholder="Username" required>
                                                    ...
                                                    <div class="form-label-group">
                                                        <input type="text" id="inputName" name="lname" class="form-control" placeholder="Lastname" required>
                                                    ...
                                                    <button type="submit" name="signup_btn" class="btn btn-primary float-right btn-inline mb-50">Register</a>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
