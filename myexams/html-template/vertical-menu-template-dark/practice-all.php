        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <section id="data-list-view" class="data-list-view-header">
                    ...
                    <!-- DataTable starts -->
                  <?php  $practice_questions= practice_question();?>
                    <div class="table-responsive">
                        <table class="table data-list-view">
                            ...
                            <tbody>
                            <?php  foreach($practice_questions as $practice_question){ ?>
                                <tr>
                                    <td></td>
                                    <td><?php echo $i++; ?></td>
                                <td><?= $practice_question['practice_question']; ?></td>
                                <td> <?php
                        $options= practice_option($practice_question['practice_id']);
                      ...
                      <?php } ?></td>
                      <td>
                      <?php $answers= practice_answer($practice_question['practice_id']);
