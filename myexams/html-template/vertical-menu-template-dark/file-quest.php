                                        ...
                                        <li class="d-inline-block mr-2">
                                                <fieldset>
                                                    <div class="vs-radio-con vs-radio-success">
                                                        <input type="radio" name="files" value="false">
                                                        <span class="vs-radio">
                                            ...
                                            <li class="d-inline-block mr-2">
                                                <fieldset>
                                                    <div class="vs-radio-con vs-radio-success">
                                                        <input type="radio" name="questions" value="false">
                                                        <span class="vs-radio">
                                                            <span class="vs-radio--border"></span>
                                                            <span class="vs-radio--circle"></span>
                                                        </span>
                                                        <span class="">Create Question</span>
                                                    </div>
                                                </fieldset>
                                            </li>
                                            <button class="btn btn-primary" name="file-quest-submit" type="submit" style="margin-top: 100px; margin-left:-200px">SUBMIT</button>
                                            <a href="subject.php" ><button type="button"class="btn btn-primary" style="margin-top: 100px;">CANCEL</button>
                                        </ul>
                                    </div>
                                </div>
                            </div>
