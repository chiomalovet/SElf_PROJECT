            ...
            <div class="sidebar-left">
                <div class="sidebar">
                    ...
                    <form action="controller.php" method="post">
                            <label><h2>Option Name</h2>
                 <input type="text" name="option_name">
                 </label>         
                <p><h4> <input type="submit" name="option_submit" value="SUBMIT" style="margin-top:5px; margin-left:15px; background-color:green; color:white; border:none"></h4></p>
                    </form>
                        </div>
            </div>
                    </div>
